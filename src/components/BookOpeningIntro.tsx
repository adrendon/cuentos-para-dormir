...
const styles = StyleSheet.create({
  ...
  coverFront: { ...StyleSheet.absoluteFillObject, borderRadius: 7, overflow: 'hidden', backfaceVisibility: 'hidden' },
  ...
  modeBackground: { ...StyleSheet.absoluteFillObject, width: '100%', height: '100%' },
  modeShade: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(8, 4, 30, 0.66)' },
