...
const styles = StyleSheet.create({
  ...
  coverFront: { position:'absolute',top:0,right:0,bottom:0,left:0, borderRadius: 7, overflow: 'hidden', backfaceVisibility: 'hidden' },
  coverBack: { position:'absolute',top:0,right:0,bottom:0,left:0, borderRadius: 7, backfaceVisibility: 'hidden', transform: [{ rotateY: '180deg' }] },
  ...
  modeBackground: { position:'absolute',top:0,right:0,bottom:0,left:0, width: '100%', height: '100%' },
  modeShade: { position:'absolute',top:0,right:0,bottom:0,left:0, backgroundColor: 'rgba(8, 4, 30, 0.66)' },
