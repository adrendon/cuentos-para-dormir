...
export function RecordComingSoonPanel({
  firstPageUri,
  onClose,
}: {
  firstPageUri?: string;
      ...
      >
        ...
        >
          <Image
            ...
            style={{ width: 14 * uiScale, height: 14 * uiScale, tintColor: '#20A9E0' }}
          />
        </TouchableOpacity>
        <Text style={[styles.sectionTitle, { fontSize: 16 * uiScale }]}>
          Narraciones personales
        </Text>
        <Text style={[styles.description, { fontSize: 12.5 * uiScale }]}>
        ...
        <TouchableOpacity
          ...
          disabled
          accessibilityLabel="Grabar (próximamente)"
        >
          <View
            style={[
              styles.recordCircle,
              { width: 32 * uiScale, height: 32 * uiScale, borderRadius: 16 * uiScale },
            ]}
          >
            <View
              style={[
                styles.recordDot,
                { width: 12 * uiScale, height: 12 * uiScale, borderRadius: 6 * uiScale },
              ]}
            />
          </View>
...
const styles = StyleSheet.create({
  ...
  recordButton: {
    ...
    alignItems: 'center',
    alignSelf: 'center',
    backgroundColor: 'rgba(95,101,120,0.12)',
    gap: 12,
    opacity: 0.62,
  },
  recordCircle: {
