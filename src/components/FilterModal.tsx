...
const CHIPS: { key: keyof LibraryFilters; label: string; category: ChipCategory }[] = [
  { key: 'unread', label: 'No leídos', category: 'purple' },
  { key: 'notDownloaded', label: 'No descargados', category: 'purple' },
  { key: 'favorites', label: 'Favoritos', category: 'cyan' },
  { key: 'read', label: 'Leídos', category: 'cyan' },
  { key: 'short', label: 'Cortos (< 30 páginas)', category: 'orange' },
  { key: 'long', label: 'Largos (> 40 páginas)', category: 'orange' },
];
      ...
      <Animated.View style={[styles.backdrop, { opacity: entrance }]}>
        ...
        >
                  ...
                  return (
                    ...
                    >
                      <Text
                        style={[
                          styles.chipText,
                          { color, fontSize: 29 * scale, lineHeight: 37 * scale },
          ...
          <View style={[styles.footer, { height: 138 * scale, gap: 22 * scale }]}>
            <TouchableOpacity
              style={[styles.cancelButton, buttonSize(scale)]}
            ...
            >
              {hasActiveFilter ? (
                <LinearGradient
                  ...
                  style={[styles.applyButton, buttonSize(scale)]}
                >
...
const styles = StyleSheet.create({
  ...
  footer: {
    ...
    borderTopColor: 'rgba(96,99,113,.20)',
  },
